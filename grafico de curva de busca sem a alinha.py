...
CORES = {
    "seq_random": "#000000",      # azul
    "seq_sorted": "#303030",      # laranja
    "seq_reverse": "#515151",     # verde
    "bin": "#002252",             # vermelho
    "abb_random": "#0080FF",      # azul
    "abb_sorted": "#ACB900",      # laranja
    "abb_reverse": "#fbff00",     # verde
    "avl_random": "#ff0000",      # azul
    "avl_sorted": "#960000",      # laranja
    "avl_reverse": "#760000"      # verde
}
...
def gerar_grafico_unico(dados_grafico, metrica, nome_grafico, x_min=None, x_max=None, y_min=None, y_max=None):
    ...
    for dados in dados_grafico:
        ...
        # Detectar se é AVL
        eh_avl = arquivo.startswith('avl')
        
        # Tamanho e borda diferentes para AVL
        if eh_avl:
            tamanho = 100
            largura_borda = 2.5
            cor_borda = 'black'
        ...
        ax.scatter(x, y, color=cor, s=tamanho, alpha=alpha, 
                  label=f'{nome_arquivo_limpo}',
                  marker=marcador, zorder=3, edgecolors=cor_borda, linewidth=largura_borda)
